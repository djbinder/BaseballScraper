...
#pragma warning disable CC0091, CS0219, CS0414, IDE0044, IDE0051, IDE0052, IDE0059, IDE0060, IDE1006, MA0016
namespace BaseballScraper.Infrastructure
{
    public class PythonConnector
    {
        ...
        public PythonConnector(Helpers helpers)
        {
        ...
        {
            int kvpNumber = 1;
            foreach(KeyValuePair<string, dynamic> kvp in pythonKeyValuePairs)
            {
        ...
        {
            int kvpNumber = 1;
            foreach(KeyValuePair<string, object> kvp in pythonKeyValuePairs)
            {
                Console.WriteLine(kvpNumber);
                Console.WriteLine($"KEY: {kvp.Key}  VALUE: {kvp.Value}");
                Console.WriteLine();

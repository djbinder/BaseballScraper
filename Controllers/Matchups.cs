...
namespace BaseballScraper
{
    public class MatchupsConroller : Controller
    {
        ...
        public void GameMatchups()
        {
            ...
            int[] winnerData = new[] { 10, 5, 8, 2, 1, 10, 7, 4, 2, 1, 10, 5, 2, 8, 9, 2, 9, 1, 3, 10, 2, 6, 4, 9, 10, 7, 5, 9, 8, 10, 7, 1, 2, 9, 10, 7, 2, 9, 7, 5, 6, 2, 10, 4, 6, 3, 9, 5, 9, 4, 8, 1, 6, 7, 4, 1, 3, 10, 7, 5, 3, 1, 7, 6, 4, 9, 10, 1, 2, 6, 4 };
            // the team number of the losing team for each Yahoo weekly matchup (e.g., 10 = djb)
            int[] loserData  = new[] { 7, 4, 6, 3, 9, 5, 9, 6, 8, 3, 6, 7, 4, 1, 3, 10, 5, 4, 8, 1, 7, 5, 3, 8, 3, 1, 2, 6, 4, 8, 3, 5, 6, 4, 4, 8, 9, 10, 4, 8,3, 1, 7, 5, 8, 2, 1, 10, 7, 6, 2, 3, 10, 5, 2, 8, 9, 2, 6, 9, 8, 10, 2, 5, 3, 8, 3, 7, 5, 9, 8 };

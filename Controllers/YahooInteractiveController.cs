...
namespace BaseballScraper.Controllers
{
    ...
    public class InteractiveController: Controller
    {
        ...
        [HttpPost ("[action]")]
        public async Task<List<Game>> GetGames ([FromBody] YahooPostModel model)
        {
        ...
        [HttpPost ("[action]")]
        public async Task<List<League>> GetLeagues ([FromBody] YahooPostModel model)
        {

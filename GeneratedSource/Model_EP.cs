...
namespace Models
{
	...
	public partial class Model_EP : IGeneratedAlgorithm
	{
		...
		public int[] vint__0
		{
			...
			set {
				if ((value!=null)&&(value.Length!=85)) {
					throw new ArgumentException(((("Provided array of length "+value.Length)+" when length ")+85)+" was expected for variable \'vint__0\'");
				}
				this.Vint__0 = value;
		...
		public int[] vint__1
		{
			...
			set {
				if ((value!=null)&&(value.Length!=85)) {
					throw new ArgumentException(((("Provided array of length "+value.Length)+" when length ")+85)+" was expected for variable \'vint__1\'");
				}
				this.Vint__1 = value;
				this.numberOfIterationsDone = 0;
				this.Changed_numberOfIterationsDecreased_Init_vint__0_vint__1_isInitialised = false;
		...
		private void Changed_numberOfIterations_vint__0_vint__1(int numberOfIterations)
		{
			...
			vdouble__0_itemvint__1_index0__F = new DistributionStructArray<Gaussian,double>(85);
			for(int index0 = 0; index0<85; index0++) {
				vdouble__0_itemvint__1_index0__F[index0] = Gaussian.Uniform();
			}
			// Create array for replicates of 'vdouble11_F'
			DistributionStructArray<Gaussian,double> vdouble11_F = new DistributionStructArray<Gaussian,double>(85);
			for(int index0 = 0; index0<85; index0++) {
			...
			vdouble__0_itemvint__0_index0__F = new DistributionStructArray<Gaussian,double>(85);
			for(int index0 = 0; index0<85; index0++) {
				vdouble__0_itemvint__0_index0__F[index0] = Gaussian.Uniform();
			}
			// Create array for replicates of 'vdouble8_F'
			DistributionStructArray<Gaussian,double> vdouble8_F = new DistributionStructArray<Gaussian,double>(85);
			for(int index0 = 0; index0<85; index0++) {
				vdouble8_F[index0] = Gaussian.Uniform();
			}
			// Create array for replicates of 'vdouble12_F'
			DistributionStructArray<Gaussian,double> vdouble12_F = new DistributionStructArray<Gaussian,double>(85);
			for(int index0 = 0; index0<85; index0++) {
				vdouble12_F[index0] = Gaussian.Uniform();
			}
			// Create array for replicates of 'vdouble12_B'
			DistributionStructArray<Gaussian,double> vdouble12_B = new DistributionStructArray<Gaussian,double>(85);
			for(int index0 = 0; index0<85; index0++) {
				vdouble12_B[index0] = Gaussian.Uniform();
			}
			// Create array for replicates of 'vdouble8_use_B'
			DistributionStructArray<Gaussian,double> vdouble8_use_B = new DistributionStructArray<Gaussian,double>(85);
			for(int index0 = 0; index0<85; index0++) {
				vdouble8_use_B[index0] = Gaussian.Uniform();
			}
			// Create array for replicates of 'vdouble11_use_B'
			DistributionStructArray<Gaussian,double> vdouble11_use_B = new DistributionStructArray<Gaussian,double>(85);
			for(int index0 = 0; index0<85; index0++) {
		...
		private void Constant()
		{
			...
			this.vdouble__0_itemvint__1_index0__B = new DistributionStructArray<Gaussian,double>(85);
			// Create array for 'vdouble__0_itemvint__0_index0_' Backwards messages.
			this.vdouble__0_itemvint__0_index0__B = new DistributionStructArray<Gaussian,double>(85);

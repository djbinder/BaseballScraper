#
# EXAMPLE OF HOW TO RETURN OUTPUT OF A FUNCTION TO .NET
# def hello_world():
#     hello_world = "hello world!"
#     print("this is great!")
#     return hello_world;

# thisObject = hello_world();
# print thisObject;
#############
...
#         if (season>1904 or season in exceptions): code = BeautifulSoup(t[16], "html5lib")
#         # elif season<=1904: code = BeautifulSoup(t[15], "lxml")
#         elif season<=1904: code = BeautifulSoup(t[15], "html5lib")
...
# standings_current = standings()
# print("THREE")
# print(standings_current)

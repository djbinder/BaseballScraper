...
namespace BaseballScraper.Controllers
{
    ...
    public class TwitterController: ControllerBase
    {
        ...
        #region OPTION 2 ------------------------------------------------------------
            ...
            /// </summary>
            /// <remarks>
            ///     In Option 2, there is one parameter passed into the method.
            ///     To change what you are searching for, modify the parameter when calling the method
            /// </remarks>
            /// <param name="searchString">
            ///     The string that you would like to search twitter for
            /// </param>
            /// <example>
            ///     ExecuteTwitterStringSearch("anthony rizzo");
            /// </example>
            /// <returns>
            ///     A list of tweets
            /// </returns>
